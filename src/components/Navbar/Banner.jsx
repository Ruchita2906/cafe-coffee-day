...
const bgImage = {
  backgroundImage: `url(/website/coffee-texture.jpg)`, // Use public folder path for background image
          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div data-aos="zoom-in">
                <img
                  src="/coffee-white.png" // Direct path to the image in public folder
                  alt="biryani img"
